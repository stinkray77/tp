...
public class CommandTestUtil {
    ...
    public static final String VALID_REMARK_AMY = "Needs extra help";
    public static final String REMARK_DESC_AMY = " " + PREFIX_REMARK
            + VALID_REMARK_AMY;

    public static final String NAME_DESC_AMY = " " + PREFIX_NAME
            + VALID_NAME_AMY;
    public static final String NAME_DESC_BOB = " " + PREFIX_NAME
            + VALID_NAME_BOB;
    ...
    public static final String ADDRESS_DESC_BOB = " " + PREFIX_ADDRESS
            + VALID_ADDRESS_BOB;
    public static final String SUBJECT_DESC_MATH = " " + PREFIX_SUBJECT
            + VALID_SUBJECT_MATH;
    public static final String SUBJECT_DESC_ENGLISH = " " + PREFIX_SUBJECT
    ...
    public static final String PAYMENT_STATUS_DESC_AMY = " "
    ...
    public static void assertCommandSuccess(Command command,
            Model actualModel, CommandResult expectedCommandResult,
            Model expectedModel) {
        try {
    ...
    public static void showPersonAtIndex(Model model, Index targetIndex) {
        ...
        final String[] splitName =
                person.getName().fullName.split("\\s+");
