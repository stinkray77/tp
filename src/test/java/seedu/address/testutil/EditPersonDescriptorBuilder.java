...
public class EditPersonDescriptorBuilder {
    ...
    /**
     * Parses the {@code days} into a {@code Set<Day>} and set it to the {@code EditPersonDescriptor}.
     */
    ...
    /**
     * Parses the {@code times} into a {@code Set<Time>} and set it to the {@code EditPersonDescriptor}.
     */
